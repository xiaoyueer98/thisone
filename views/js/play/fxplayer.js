/***********************************************************
 * Copyright 2013 �����������ý�Ƽ����޹�˾.  All Rights Reserved.
...
function loadfxplayer(width,height,source_url,stream_type,autoplay)
{
...
liveDynamicStreamingBufferTime: 0.2, 
      ...
      swfobject.embedSWF(
				"fxplayer/StrobeMediaPlayback.swf"
				, "fxplayer"
				, width
				, height
				, "10.1.0"
				, "fxplayer/expressInstall.swf"
				, parameters
				, {
