...
<li><a href="?s=User/Logout">退出登录</a></li>
			...
			<div class="user">
			    <h3><span style="float:right">共<?php echo ($count_video); ?>条观看记录</span>我的观看记录</h3> 
			    ...
			    <ul class="pages"><?php if(!empty($list_comment)): ?><div class="comm-pager"><?php echo ($pages); ?></div><?php else: ?>没有观看记录。<?php endif; ?></ul>
			</div>
		</div>
	</form>	
  </div> 
