        ...
        <div class="right2">
            ...
            <div id="最近更新($cid)" class="show">
                ...
                <?php $tag['name'] = 'video';$tag['cid'] = ''.$cid.'';$tag['limit'] = '15';$tag['order'] = ''.$order.''; $__LIST__ = get_tag_gxlist($tag); if(is_array($__LIST__)): $i = 0;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$video): ++$i;$mod = ($i % 2 );?><li>
                        <a href="<?php echo ($video["readurl"]); ?>" class="img" target="_blank"><span><?php if($video["serial"] > 0): ?>更新至<?php echo ($video["serial"]); ?><?php else: ?>完结<?php endif; ?></span><i></i>
                        		<img onerror="this.src='<?php echo ($webpath); ?>views/images/nophoto.jpg'" src="<?php echo ($video["picurl"]); ?>" alt="<?php echo ($video["title"]); ?>"/></a>
                ...
                <!----分页 开始---->
                 ...
                 <?php if(($ekupage['count'])  >  "10"): ?><div class="pag">
                 ...
                 <?php if(is_array($ekupage['list'])): $i = 0; $__LIST__ = $ekupage['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): ++$i;$mod = ($i % 2 )?><a href="<?php echo ($vo["link"]); ?>"><?php echo ($vo["ii"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
