...
<div class="topnav">
  <div class="sitenav">
    ...
    <div class=sitelink>
    	<!--  
    	<a href="javascript:Mapshow();">功能地图</a> |
    	-->
    	<a href="?s=admin/index" target="_parent">后台首页</a> | <a href="./" target="_blank">网站主页</a> 
    	<!--  
    	| <a href="<?php echo C("cms_url");?>" target="_blank">官方论坛</a> | <a class="top-txt" href="?s=Admin/Cache/Del" target="frmright" id="delcache">更新缓存</a><a id="cache"></a>
    	-->
    	</div>
  ...
  <div class="leftnav">
    <ul>
      <li class="navleft"></li>
      <li id="d1" style="margin-left: -1px" class="thisclass"  onClick="ConClass(1);"><a href="?s=Admin/Index/main" target="main" onClick="left('?s=Admin/Index/Left/id/config');">系统管理</a></li>
      <li id="d2" onClick="ConClass(2);"><a href="?s=Admin/Video/Show" target="main" onClick="left('?s=Admin/Index/Left/id/content');">资源管理</a></li>
      <!--  
      ...
      <li id="d8" onClick="ConClass(8);"><a href="?s=Admin/Slide/Show" target="main" onClick="left('?s=Admin/Index/Left/id/tool');">扩展工具</a></li>
