...
class HtmlAction extends AdminAction{	
    ...
    public function videoshow(){
		...
		echo '<li>方讯提醒您：正在生成第 '.$start.' - '.$end.' 页，请等待</li>';
		echo '</div>';
		...
		for ($ii = $start; $ii<=$end; $ii++) {
			...
			$pages  = '共'.$count.'部视频&nbsp;当前:'.$ii.'/'.$totalpages.'页&nbsp;';
    ...
    public function videoread(){
		...
		echo'<li>总共需要生成<span>'.$count.'</span>部视频,每页生成<span>'.$listRows.'</span>部,共需要分<span>'.$totalpages.'</span>页生成,当前正在生成第<span>'.$nowpage.'</span>页。</li>';
    ...
    public function videoid(){
		...
		echo '<li>恭喜您！所选择的视频已经生成完毕</li></div>';
	}	
	//生成视频内容
